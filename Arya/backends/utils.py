    ...
    def argv_parse(self):
        ...
        if '.' in module_name:
            ...
            if module_instance:#matched
                # print('1111')
                module_obj = module_instance(self.argvs,models,settings)   #moudule_obj = cmd.CMD(self.argvs,models,settings)
                module_obj.process() #提取 主机
                if hasattr(module_obj,mod_method):                         #if hasattr(moudule_obj,apply)
